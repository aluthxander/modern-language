...
func TestExecSql(t *testing.T) {
	...
	script := "INSERT INTO customer(id, name) values('Ramadhan', 'Ramadhan')"
...
func TestAutoIncrement(t *testing.T) {
	...
	if err != nil {
		...
		fmt.Println("Success insert data with id", inserId)
	}
}
...
func TestPrepareStatement(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		email := "diman" + strconv.Itoa(i) + "@gmail.com"
		comment := "Hello World " + strconv.Itoa(i)
...
func TestTransaction(t *testing.T)  {
	...
	script := "INSERT INTO comments(email, comment) values(?, ?)"
	for i := 0; i < 10; i++ {
		email := "danu" + strconv.Itoa(i) + "@gmail.com"
		comment := "Hello World " + strconv.Itoa(i)
